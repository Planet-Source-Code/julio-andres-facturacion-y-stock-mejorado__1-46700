...
Private Sub txtpreciodecosto_KeyPress(KeyAscii As Integer)
If KeyAscii = 13 Then
SendKeys "{tab}"
KeyAscii = 0
End If
...
Private Sub txtpreciodecosto_LostFocus()
If IsNumeric(txtpreciodecosto.Text) = False Then ' Allows only numeric text
txtpreciodecosto.Text = 0
txtpreciodecosto.SetFocus
Exit Sub
End If

End Sub

Private Sub txtpreciodeventa_KeyPress(KeyAscii As Integer)
If KeyAscii = 13 Then
SendKeys "{tab}"
KeyAscii = 0
End If
...
Private Sub txtpreciodeventa_LostFocus()
If IsNumeric(txtpreciodeventa.Text) = False Then ' Allows only numeric text
txtpreciodeventa.Text = 0
txtpreciodeventa.SetFocus
Exit Sub
End If
End Sub
...
Private Sub txtstockmax_LostFocus()
If IsNumeric(txtstockmax.Text) = False Then ' Allows only numeric text
txtstockmax.Text = 0
...
If IsNumeric(txtstockmin.Text) = False Then ' Allows only numeric text
txtstockmin.Text = 0
...
Private Sub txtstockreal_KeyPress(KeyAscii As Integer)
If KeyAscii = 13 Then
SendKeys "{tab}"
KeyAscii = 0
End If
...
Private Sub txtstockreal_LostFocus()
If IsNumeric(txtstockreal.Text) = False Then ' Allows only numeric text
txtstockreal.Text = 0
txtstockreal.SetFocus
Exit Sub
End If
