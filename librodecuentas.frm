...
txtgastos.Text = Format(txtgastos.Text, "$##,##0.00")

'suma de ingresos
Data3.DatabaseName = App.Path & "\VENTAS.mdb"
Data3.RecordSource = "Select * from Librodecuentas "
Data3.DatabaseName = App.Path & "\VENTAS.mdb"
Data3.RecordSource = "SELECT  sum(Ingresos) As totalIngresos from Librodecuentas "
Data3.Refresh
txtingresos.Text = IIf(IsNull(Data3.Recordset("totalIngresos")), "", Data3.Recordset("totalIngresos"))
txtingresos.Text = Format(txtingresos.Text, "$##,##0.00")

txtsaldo.Text = Val(Str(txtingresos.Text)) - Val(Str(txtgastos.Text))
txtsaldo.Text = Format(txtsaldo.Text, "$##,##0.00")

If Val(Str(txtsaldo.Text)) < Val(Str(txtgastos)) Then
