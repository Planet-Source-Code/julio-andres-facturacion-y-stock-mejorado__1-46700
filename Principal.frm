...
'On Error GoTo error
Data2.DatabaseName = App.Path & ("\VENTAS.mdb")
Data2.RecordSource = "SELECT * FROM Articulos order by Articulo ASC"
Data7.DatabaseName = App.Path & ("\VENTAS.mdb")
Data7.RecordSource = "SELECT * FROM Librodeventas order by Ndecaja ASC"
'Data2.Refresh
'Data7.Refresh
...
txtfecha2.Text = txtdia.Text & "/" & txtmes.Text & "/" & txtaño.Text
With Data7
.Recordset.Fields("Ndecaja") = txtndeventa.Text
.Recordset.Fields("Fdepago") = Combo1.Text
.Recordset.Fields("Fecha") = txtfecha2.Text
.Recordset.Fields("Cliente") = UCase(txtcliente.Text)
.Recordset.Fields("Iva") = txtiva.Text
.Recordset.Fields("Suma") = txtsuma.Text
.Recordset.Fields("Tipo") = Command2.Caption
.Recordset.Fields("Total") = txttotal.Text
.Refresh
End With
...
Data1.RecordSource = "SELECT * FROM Clientes order by Empresa ASC"
Data2.DatabaseName = App.Path & ("\VENTAS.mdb")
Data2.RecordSource = "SELECT * FROM Articulos order by Articulo ASC"
Data3.DatabaseName = App.Path & ("\VENTAS.mdb")
Data3.RecordSource = "SELECT * FROM Ventaporpantalla order by Articulo ASC"
Data4.DatabaseName = App.Path & ("\VENTAS.mdb")
Data4.RecordSource = "SELECT * FROM Formadepago order by Pago ASC"
mnufacturar.Enabled = False
...
MsgBox "Programa de facturación y Stock  por Julio R.Andres - E-Mail:julioan@topmail.com.ar", vbExclamation, "Información acerca del Programa"
End Sub
...
txtmes = Format(Date, "MM")
txtaño = Format(Date, "YYYY")
MsgBox "La fecha ha sido cambiada por la fecha actual en los casilleros DIA - MES- AÑO", vbInformation, "FECHA"
End Sub
...
'Borra los datos de la tabla Ventaporpantalla
'cuando factura
Data3.DatabaseName = App.Path & ("\VENTAS.mdb")
